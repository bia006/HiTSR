...
class SwinTransformerModel(SRModel):
    ...
    def optimize_parameters(self, step):
        ...
        self.output = self.net_g(self.img_in_lq, self.img_ref)
        train_opt = self.opt['train']
        # accumulation_step = train_opt['accumulation_step']
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            if 'padding' in val_data.keys():
                ...
                if padding:
                    ...
                    gt_img = gt_img[:original_size[0], :original_size[1]]
