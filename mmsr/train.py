...
from mmsr.utils import dist_util 
...
def main():
    ...
    parser.add_argument("--wandb_project_name", type=str, default="Ref_SR", help='Project name')
    ...
    # opt["train"]["lr_g"] = args.lr_g
    # opt["train"]["accumulation_step"] = args.accumulation_step
    # print("----->", type(opt["train"]["lr_g"]))
    if wandb and args.use_wandb:
        wandb.init(project="Ref_SR", name=args.wandb_project_name, reinit=True)
